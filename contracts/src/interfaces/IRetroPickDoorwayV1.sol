...
/**
 * @notice Shared RetroPick Doorway V1 interfaces.
 *
 ...
 *
 * `IRetroPickDoorwayV1` describes the external surface of the primary
 * orchestrator (`RetroPickDoorwayV1`). The remaining interfaces are narrow
 ...
 */
interface IRetroPickDoorwayRegistryV1 {
 ...
 */
interface IRetroPickDoorwayVaultV1 {
 ...
 */
interface IRetroPickDoorwayStakingV1 {
