...
/**
 * @notice Every input RetroPickLaunchFactoryV1 hands the deployer to stand up one
...
struct LaunchDeployment {
    ...
    IRetroPickFeePolicyV1 feePolicy;
    FeePolicySnapshot policy;
    IRetroPickFeeEscrowV1 feeEscrow;
    RetroPickBuybackVaultV1 buybackVault;
...
/**
 * @title RetroPickLaunchDeployerV1
 * @notice Deploys the bonding curve and launch token pair for one RetroPick V1
 * launch on RetroPickLaunchFactoryV1's behalf. Split out into its own contract
 * purely so RetroPickLaunchFactoryV1's own bytecode stays under EIP-170's
 ...
 */
contract RetroPickLaunchDeployerV1 {
