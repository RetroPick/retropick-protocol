...
/**
 * @notice Shared RetroPick V1 interfaces: fee escrow, fee policy, and the launch
...
/**
 * @notice Claimable balance ledger shared by every v1 bonding curve and the
 ...
 */
interface IRetroPickFeeEscrowV1 {
 ...
 */
interface IRetroPickFeePolicyV1 {
    ...
    function feeEscrow() external view returns (IRetroPickFeeEscrowV1);
...
/**
 * @notice Minimal ERC-721 receiver signature used by RetroPickLaunchLockerV1 to
...
/**
 * @notice Record kept by RetroPickLaunchFactoryV1 for every launch, readable by
 * the locker and by off-chain indexers.
 */
interface IRetroPickLaunchFactoryV1 {
 ...
 */
interface IRetroPickBondingCurveV1 {
