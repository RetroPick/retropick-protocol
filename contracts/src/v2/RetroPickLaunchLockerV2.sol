...
/**
 * @title RetroPickLaunchLockerV2
 * @notice Permanently holds the graduated Uniswap V4 position NFT for every
 * RetroPick V2 launch. Unlike the previous-generation locker, there is no `collectFees()` here: fee
 * collection and distribution belong entirely to RetroPickMemeHookV2 and
 * RetroPickFeeEscrowV2, since a V4 position accrues fees inside the singleton
 ...
 */
contract RetroPickLaunchLockerV2 is Ownable2Step, IERC721ReceiverLike {
