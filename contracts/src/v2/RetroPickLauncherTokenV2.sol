...
/**
 * @title RetroPickLauncherTokenV2
 * @notice Fixed-supply ERC-20 deployed by RetroPickLaunchFactoryV2 for a v2 launch.
 ...
 * locked into `RetroPickBuybackVaultV2` for a five-year vest instead of being
 * burned.
 */
contract RetroPickLauncherTokenV2 is ERC20, ERC20Burnable {
    struct Socials {
        string twitter;
        string telegram;
        string discord;
    ...
    constructor(
        ...
        // deploys this token indirectly through RetroPickLaunchDeployerV2 to keep its
