 ...
 * buyback-and-burn split that governs RetroPickBondingCurveV2's pre-graduation
 * fee sweep lives here, read live by the curve through IRetroPickFeePolicyV2 so
 * both phases behave identically.
 */
contract RetroPickMemeHookV2 is BaseHook, IUnlockCallback, IRetroPickFeePolicyV2, Ownable2Step, ReentrancyGuard {
    ...
    struct LaunchInfo {
        ...
        // Creator-chosen at launch on RetroPickLaunchFactoryV2, snapshotted here
    ...
    // Mirrors RetroPickBondingCurveV2's own ceiling, so a graduated pool can never
     ...
     */
    function setBuybackVault(RetroPickBuybackVaultV2 buybackVault_) external onlyOwner {
