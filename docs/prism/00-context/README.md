...
Stable project identity, vocabulary, vision, constraints, and the human-facing project overview.

## Start here

1. [`EXECUTIVE_SUMMARY.md`](EXECUTIVE_SUMMARY.md) — canonical human-facing overview of RetroPick + PRISM, the math thesis, lifecycle, architecture, current phase, and next work.
2. [`PROJECT.md`](PROJECT.md) — concise project identity.
3. [`VISION.md`](VISION.md) — long-term product direction.
