...
/// @notice Split 4, resolve YES_WIN, redeem 1 NO.
/// @dev liability, redeemNo, and the payout formula are not edited.
contract LosingNoRedeemTest is Test {
    ...
    function setUp() public {
        ...
        market = new PredictionMarket(
            address(collateral), resolver, dustSink, bytes32("losing-no"), "Yes", "YES", "No", "NO"
        );
        market.activate();
    ...
    function test_redeem_one_no_after_yes_win() public {
        vm.prank(alice);
        market.split(4);
        ...
        emit log_string("yes_redeemed_after: 0");
