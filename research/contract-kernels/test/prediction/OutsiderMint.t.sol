...
/// @notice A non-market caller mints 1 YES after a positive split.
/// @dev OutcomeToken.mint is not edited. Python has no OutcomeToken.
contract OutsiderMintTest is Test {
    ...
    function setUp() public {
        ...
        market = new PredictionMarket(
            address(collateral), resolver, dustSink, bytes32("outsider-mint"), "Yes", "YES", "No", "NO"
        );
        market.activate();
    ...
    function test_outsider_mint_of_one_yes_leaves_supply() public {
        vm.prank(alice);
