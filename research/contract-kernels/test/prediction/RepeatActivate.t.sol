...
/// @notice A second activate after the market is already OPEN.
contract RepeatActivateTest is Test {
    ...
    function setUp() public {
        ...
        market = new PredictionMarket(
            address(collateral), resolver, dustSink, bytes32("repeat-activate"), "Yes", "YES", "No", "NO"
        );
        market.activate();
    }

    function test_second_activate_leaves_open_books_at_zero() public {
