...
| Settlement balance below the floor | accounting | existing_rule. `PayoutExceedsBalance`. rebaseDown of 2 leaves balance 0 below floor 1. `redeemable` stays true. `paidRaw` stays 0. `deep-rebasing-settlement-funding-2026-09-26.json` |
